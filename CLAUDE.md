...
Mobile-first search: 🔍 in the toggle cluster opens a search bar; typing a flight number ("BR178" or "178") renders that flight's gate/carousel **without the 2-hour window**, for today only.
